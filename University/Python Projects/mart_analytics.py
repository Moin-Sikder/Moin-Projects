# mart_analytics.py
"""
Comprehensive Marketing Analytics for Retail Data
Analysis of mart.csv dataset with multiple marketing projects
"""
...
class MartAnalytics:
    ...
    def project_1_marketing_roi_analysis(self):
        ...
        plt.tight_layout()
        plt.savefig('marketing_roi_analysis.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def project_4_marketing_mix_modeling(self):
        ...
        plt.tight_layout()
        plt.savefig('marketing_mix_modeling.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def project_6_promotional_effectiveness(self):
        ...
        plt.tight_layout()
        plt.savefig('promotional_effectiveness.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def project_8_external_factors_analysis(self):
        ...
        plt.tight_layout()
        plt.savefig('external_factors_analysis.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def project_9_store_performance_comparison(self):
        ...
        plt.tight_layout()
        plt.savefig('store_performance_comparison.png', dpi=300, bbox_inches='tight')
        plt.show()
    ...
    def project_10_marketing_budget_optimization(self):
        ...
        plt.tight_layout()
        plt.savefig('marketing_budget_optimization.png', dpi=300, bbox_inches='tight')
        plt.show()
